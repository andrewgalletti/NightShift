 ...
 */
public class OldGhost extends Sprite {

    private static final int RANGE = 150;
    private static Texture img = new Texture(Gdx.files.internal("OldGhost.png"));
    ...
    public OldGhost(Janitor hero, int xPos, int yPos, World world) {
    ...
    public void chase() {
        ...
        float spriteX = getX(); //OldGhost's
        float spriteY = getY();
        float x2 = getX(); //OldGhost's new position
        float y2 = getY();
        float angle;
